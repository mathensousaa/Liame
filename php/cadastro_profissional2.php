...
// validacao da senha
    if($confirmarsenha_profissional == $senha_profissional){
        ...
        if($conta>=1){
            ...
            $query = 'INSERT INTO profissional (nome_profissional, email_profissional, senha_profissional, status_validacao_profissional) VALUES ("'.$nome_profissional.'", "'.$email_profissional.'", "'.$senha_criptografada_profissional.'", "0")';
            
            if (mysqli_query($link, $query)){
                echo "Cadastrado com sucesso";
                header('Location: ../index.php');
            }else{
                header('Location: erro_cadastro_profissional');
