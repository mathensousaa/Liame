...
<body>
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav ms-auto me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="procura_profissional1.php">Buscar especialistas</a>
                </li>
                <li class="nav-item">
  ...
  <footer>
    <div id="rodape" class="container fixed-bottom">
          ...
          <div class="py-lg-0 py-mb-5 col-md-8 d-flex justify-content-center align-self-center">
            <div class="px-lg-4 px-mb-1">
              ...
              <ul class="list-unstyled">
                <li class=""><a href="procura_profissional1.php">Consultas</a></li>
