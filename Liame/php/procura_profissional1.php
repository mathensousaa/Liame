				...
				<div class="row">
					<div class="col-md-12 align-center text-center">
						...
						<div class="col-12 container-fluid">
							<form name="pesquisa-profissional" action="procura_profissional2.php" class="px-lg-5 mx-lg-5" method="post">
								<div id="input-busca" class="input-group my-5">
                    ...
                    if($resul_especialidade->num_rows > 0){
                      while($exibe = $resul_especialidade->fetch_array()){
                        ?>
                          <option value="<?php echo $exibe['id_especialidade']; ?>"> <?php echo utf8_encode($exibe['especialidade']); ?></option>
                        <?php
>>>>>>> 54bd923b860f94313185483d87c49662f6c8cfac
                      }
                    }
                  ?>
										</select>
...
<<<<<<< HEAD
									...
									<div class="btn-container col-md-3 col-sm-12">
