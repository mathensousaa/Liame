          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <div id="login" class="nav navbar-nav">
                <div class="nav-item">
                <a href="php/logout_mae.php"  class="button button-primary btn btn-outline-primarynav-item ">
                    Sair
                  </a>
                  <!-- Modal -->
        ...
        <nav class="navbar navbar-expand-lg navbar-light justify-content-between">
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <div id="login" class="nav navbar-nav">
                <div class="nav-item">
                  <a href="php/logout_profissional.php"  class="button button-primary btn btn-outline-primarynav-item ">
                    Sair
                  </a>
                  <!-- Modal -->
                  <div class="modal fade" id="modal-login" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <nav class="navbar navbar-expand-lg navbar-light justify-content-between">
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <div id="login" class="nav navbar-nav">
                <div class="nav-item">
                  <a href="php/logout_adm.php"  class="button button-primary btn btn-outline-primarynav-item ">
                    Sair
                  </a>
                  <!-- Modal -->
                  <div class="modal fade" id="modal-login" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
